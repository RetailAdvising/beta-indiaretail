...
export default function Home({ data }) {
  ...
  return (
    <>
      ...
      <RootLayout ad_payload={{ page: "Home", page_type: "Landing" }} data={data} isLanding={true} head={''} adIdH={'home-head'} adIdF={'home-foot'} homeAd={ads && ads.header ? ads : null} resetKey={router.asPath}>
                      ...
                      return (
                        <div key={c.component_title} className={`${c.component_title == "Infocus Ad" ? 'md:pb-[10px]' : ''} ${c.component_title == "Top 4 Stories" ? 'top3  lg:justify-center md:gap-5' : c.component_title == "Featured Content" ? 'md:mb-[20px] pt-[20px]' : ''}`}>
                          ...
                          {(ads && c.component_title == "Infocus Ad" && data.section == 'Infocus' && c.cid && data.data[c.cid]) &&
                            <Advertisement ad_payload={{ page: "Home", page_type: "Landing" }} data={ads.infocus ? ads.infocus : null} position={'small'} adPos={'300'} adId={'infocus'} insStyle={"display:inline-block;width:300px;height:250px;"} divClass={`h-[250px] tab:w-full w-[300px] m-auto`} resetKey={router.asPath} />
                          }
                          ...
                          {(c.cid && data.data[c.cid] && data.data[c.cid].data && c.component_title == "Web Special" && c.component_data_type == 'Location') && <>
                            ...
                            <div className={`lg:flex gap-5`}>
                              ...
                              <div className='md:my-[15px]'>
                                <Advertisement ad_payload={{ page: "Home", page_type: "Landing" }} data={ads && ads.web_special ? ads.web_special : null} position={'small'} adPos={'300'} adId={'web_special'} insStyle={"display:inline-block;width:300px;height:250px;"} divClass={`h-[250px] w-[300px] m-auto`} resetKey={router.asPath} />
                              </div>
                            </div>
                          ...
                          {(c.cid && books && books.length != 0 && c.component_title == "Book Store") && <>
                            ...
                            <div className={`lg:grid gap-5 lg:grid-cols-5  flex overflow-scroll`}><Card isHome={true} imgClass={'lg:h-[300px] md:h-[225px] mouse aspect-[2/2.5]'} check={true} flex={'md:flex-[0_0_calc(50%_-_10px)]'} data={books} boxShadow={true} /></div>
                          </>}
