          ...
          <div className={`lg:bg-[#FBFBFD]`}>
            ...
            <div className='md:flex-wrap  md:p-[15px] py-8 container justify-between gap-[15px] flex'>
              <div className={`flex-[0_0_calc(100%_-_10px)] md:flex-[0_0_calc(100%_-_0px)]`}>
                ...
                {/* [270px] w-[181px] */}
                <div className={`grid gap-[20px] grid-cols-5 md:grid-cols-2 `}><Card imgClass={'lg:h-[300px] md:h-[225px] mouse'} category={data[0].route} check={true} isLanding={true} data={data[0].products.slice(0, 10)} boxShadow={true} /></div>
              </div>
